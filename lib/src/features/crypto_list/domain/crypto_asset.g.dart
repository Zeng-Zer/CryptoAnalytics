...
_$_CryptoAsset _$$_CryptoAssetFromJson(Map<String, dynamic> json) =>
    _$_CryptoAsset(
      ...
      supply: doubleFromNullable(json['supply'] as String?),
      maxSupply: doubleFromNullable(json['maxSupply'] as String?),
      marketCapUsd: doubleFromNullable(json['marketCapUsd'] as String?),
      volumeUsd24Hr: doubleFromNullable(json['volumeUsd24Hr'] as String?),
      priceUsd: doubleFromNullable(json['priceUsd'] as String?),
      changePercent24Hr:
